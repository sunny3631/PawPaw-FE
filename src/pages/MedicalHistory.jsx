  ...
  const [historyData, setHistoryData] = useState([
    {
      ...
      hospitalName: "행복한 내과",
      doctor: "이수민",
      diagnosis: "고열, 두통 증세가 보임, 3일 뒤에 병원 재방문 요망",
      prescription: "1일 3회 식후 복용",
      feedback: "꼼꼼히 진료를 잘해주셨다.",
    },
    {
      id: 2,
      date: "2024년 10월 15일",
      ...
      hospitalName: "미소 치과",
      doctor: "김세종",
      diagnosis: "사랑니 2개 발치함, 3일 뒤에 병원 재방문 요망",
      prescription: "1일 2회 식전 복용",
      feedback: "꼼꼼히 진료를 잘해주셨다.",
    },
    {
      id: 3,
      ...
      hospitalName: "사랑 약국",
      doctor: "박진환",
      diagnosis: "급성 위염 증세가 보임, 3일 뒤에 병원 재방문 요망",
      prescription: "1일 2회 식후 복용",
      feedback: "꼼꼼히 진료를 잘해주셨다.",
    },
  ]);
