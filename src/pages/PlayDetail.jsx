  ...
  return (
    <Layout>
     <Header>
      ...
      <EffectSection>
        <Effect>발달 효과</Effect>
        <EffectButton>소근육 운동</EffectButton>
      </EffectSection>
      <PlayCard>
        <PlayText>누가 누가 높이 쌓나</PlayText>
        <PlayImage src={ImgPlay} alt="누가 누가 높이 쌓나" />
      </PlayCard>
        <Section>
          <Label>기대 효과</Label>
          <Value>{detail.expectation}</Value>
        </Section>
        <Section>
          <Label>놀이 방법</Label>
          <Value>{detail.method}</Value>
        </Section>
        <Section>
          <Label>필요 재료</Label>
